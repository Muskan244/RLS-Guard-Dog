    ...
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
        <div className="text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-blue-600/10 px-3 py-1 text-xs font-medium text-blue-600 dark:text-blue-300 ring-1 ring-blue-600/20">
